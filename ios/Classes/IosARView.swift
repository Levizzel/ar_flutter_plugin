        ...
        return Future {promise in
            ...
            switch (dict_node["type"] as! Int) {
                ...
                case 3: //fileSystemAppFolderGLTF2
                    ...
                    break
                case 4: //text
                    if let node: SCNNode = self.modelBuilder.makeNodeFromText(name: dict_node["name"] as! String, text: dict_node["uri"] as! String, transformation: dict_node["transformation"] as? Array<NSNumber>) {
                        if let anchorName = dict_anchor?["name"] as? String, let anchorType = dict_anchor?["type"] as? Int {
                            switch anchorType{
                                case 0: //PlaneAnchor
                                    if let anchor = self.anchorCollection[anchorName]{
